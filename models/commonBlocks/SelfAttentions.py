...
3. 位置感知（位置敏感）注意力：Location-Aware (Location Sensitive) Attention	
Chorowski et al., 2015. Attention-Based Models for Speech Recognition.
4. 缩放点积注意力：Scaled Dot-Product Attention	
Vaswani et al., 2017. Attention Is All You Need.
5. 多头注意力：Multi-Head Attention	
Vaswani et al., 2017. Attention Is All You Need.
6. 相对多头自注意力：Relative Multi-Head Self Attention	
ZihangDai et al., 2019. Transformer-XL: Attentive Language Models Beyond a Fixed-Length Context.
7. 3和5的结合，MultiHeadLocationAwareAttention
8. 3和5的结合，CustomizingAttention
"""
...
class CustomizingAttention(nn.Module):
    ...
    def forward(self, query: Tensor, value: Tensor, last_attn: Tensor) -> Tuple[Tensor, Tensor]:
        ...
        context, attn = self.scaled_dot_attn(query, query, value)
        attn = attn.squeeze()
