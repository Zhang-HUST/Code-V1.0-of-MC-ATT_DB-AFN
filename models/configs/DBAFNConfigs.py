...
def common_cnn_configs():
    ...
    configs = (Conv1, BN1, Activation1, Pooling1, Dropout1, Conv2, BN2, Activation2, Pooling2, Dropout2)

    return configs


def branch_cnn_configs(modal):
    ...
    configs = (Conv3, BN3, Activation3, Pooling3, Dropout3, Conv4, BN4, Activation4, Pooling4, Dropout4,
               Conv5, BN5, Activation5, Pooling5, Dropout5, Conv6, BN6, Activation6, Pooling6, Dropout6)

    return configs


def linear_configs():
    Linear1 = {'in_dim': 256, 'out_dim': 32}
